...
export default function PurchaseAnalysisPage() {
  ...
  return (
    <div className="p-4 md:p-6 space-y-5">
      <div>
        <h1 className="text-2xl font-bold">{dict.nav?.purchaseAnalysis ?? '採購分析報表'}</h1>
        <p className="text-sm text-gray-500 mt-0.5">採購趨勢、供應商占比、品項採購量分析</p>
      </div>
        ...
        <div>
          ...
          <Select value={view} onValueChange={v => { if (v) setView(v as ViewKey) }}>
            ...
            <SelectContent>
              ...
              <SelectItem value="supplier">供應商分析</SelectItem>
      ...
      {searched && view === 'monthly' && (
        <div className="space-y-4">
          <div className="bg-white border rounded-xl p-4">
            <h3 className="font-semibold mb-3 text-sm">月度採購金額趨勢</h3>
            <ResponsiveContainer width="100%" height={280}>
              <BarChart data={monthly} margin={{ top: 4, right: 8, left: 0, bottom: 4 }}>
                ...
                <Bar dataKey="totalAmount" fill="#3b82f6" name="採購金額" radius={[3,3,0,0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
      ...
      {searched && view === 'supplier' && (
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-white border rounded-xl p-4">
            <h3 className="font-semibold mb-3 text-sm">供應商占比</h3>
          ...
          <div className="rounded-xl border bg-white overflow-x-auto">
            <table className="w-full text-sm">
              <thead><tr className="border-b bg-gray-50 text-xs text-gray-500">
                ...
                <th className="px-4 py-3 text-right">訂單數</th>
                <th className="px-4 py-3 text-right">採購金額</th>
      ...
      {searched && view === 'product' && (
        <div className="space-y-4">
          <div className="bg-white border rounded-xl p-4">
            <h3 className="font-semibold mb-3 text-sm">品項採購金額 TOP 15</h3>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={products.slice(0, 15)} layout="vertical" margin={{ left: 140, right: 16, top: 4, bottom: 4 }}>
                ...
                <Tooltip formatter={tooltipFmt} />
                <Bar dataKey="subtotal" fill="#10b981" name="採購金額" radius={[0,3,3,0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
          <div className="rounded-xl border bg-white overflow-x-auto">
            <table className="w-full text-sm">
              <thead><tr className="border-b bg-gray-50 text-xs text-gray-500">
                ...
                <th className="px-4 py-3 text-right">採購量</th>
                <th className="px-4 py-3 text-right">採購金額</th>
